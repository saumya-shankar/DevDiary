...
#adj_mat.to_csv('adj_mat_dataframev7.csv',index=False)
...
np.save("all_pairs_ts_data_X_trainv7_exp1_strat.npy",X_train)
np.save("all_pairs_ts_data_y_trainv7_exp1_strat.npy",y_train)
np.save("all_pairs_ts_data_X_testv7_exp1_strat.npy",X_test)
np.save("all_pairs_ts_data_y_testv7_exp1_strat.npy",y_test)
...
np.save("all_pairs_ts_data_X_trainv7_exp2.npy",X_train)
np.save("all_pairs_ts_data_y_trainv7_exp2.npy",y_train)
np.save("all_pairs_ts_data_X_testv7_exp2.npy",X_test)
np.save("all_pairs_ts_data_y_testv7_exp2.npy",y_test)
