...
np.save("GraphWise_X_trainv7_multiobject_exp2_exp5_v2.npy",ts_data_train)
np.save("GraphWise_X_testv7_multiobject_exp2_exp5_v2.npy",ts_data_test)
np.save("GraphWise_X_f_trainv7_multiobject_exp2_exp5_v2.npy",ts_data_f_train)
np.save("GraphWise_X_f_testv7_multiobject_exp2_exp5_v2.npy",ts_data_f_test)
np.save("GraphWise_y_trainv7_multiobject_exp2_exp5_v2.npy",adj_mat_train)
np.save("GraphWise_y_testv7_multiobject_exp2_exp5_v2.npy",adj_mat_test)
